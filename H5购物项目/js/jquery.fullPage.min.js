...
(function (d, k) {
    "function" === typeof define && define.amd ? define(["jquery"], function (m) {
        return k(m, d, d.document, d.Math)
    }) : "undefined" !== typeof exports ? module.exports = k(require("jquery"), d, d.document, d.Math) : k(jQuery, d, d.document, d.Math)
})("undefined" !== typeof window ? window : this, function (d, k, m, p, E) {
    var n = d(k),
        t = d(m),
        ka;
    d.fn.fullpage = function (c) {
        function y() {
            c.css3 && (c.css3 = La());
            c.anchors.length || (c.anchors = d("[data-anchor]").map(function () {
        ...
        function Ma() {
            ...
            d(".fp-section").each(function (a) {
                ...
                "undefined" !== typeof c.anchors[a] && b.hasClass("active") &&
                    W(c.anchors[a], a);
                c.menu && c.css3 && d(c.menu).closest(".fullpage-wrapper").length && d(c.menu).appendTo(q);
                0 < f ? Oa(b, g, f) : c.verticalCentered && na(b)
            });
            c.fixedElements && c.css3 && d(c.fixedElements).appendTo(q);
            c.navigation && Pa();
            c.scrollOverflow ? ("complete" === m.readyState && oa(), n.on("load", oa)) : pa()
        }
        ...
        function Oa(a, b, g) {
            ...
            1 < g && (c.controlArrows && Qa(a),
                c.slidesNavigation && Ra(a, g));
            b.each(function (a) {
                d(this).css("width", e + "%");
                c.verticalCentered && na(d(this))
            });
        ...
        function pa() {
            ...
            d.isFunction(c.afterRender) && c.afterRender.call(h)
        }

        function ra() {
            var a;
            if (!c.autoScrolling || c.scrollBar) {
                for (var b = n.scrollTop(), g = 0, f = p.abs(b - m.querySelectorAll(".fp-section")[0].offsetTop), e = m.querySelectorAll(".fp-section"),
                        h = 0; h < e.length; ++h) {
                ...
                if (!a.hasClass("active") && !a.hasClass("fp-auto-height")) {
                    ...
                    if (k.length) var l = k.data("anchor"),
                        y = k.index();
                    v && (a.addClass("active").siblings().removeClass("active"), d.isFunction(c.onLeave) && c.onLeave.call(b, g, h, f), d.isFunction(c.afterLoad) && c.afterLoad.call(a, e, h), K(a), W(e, h - 1), c.anchors.length &&
                        (z = e, Z(y, l, e, h)));
                    clearTimeout(aa);
                ...
                c.fitToSection && (clearTimeout(ba), ba = setTimeout(function () {
                    v && c.fitToSection && (d(".fp-section.active").is(a) && requestAnimFrame(function () {
                        u = !0
        ...
        function Sa(a) {
            ...
            if (!sa(a.target) && ca(b)) {
                ...
                v && !w && (b = ta(b), F = b.y, M = b.x, a.find(".fp-slides").length && p.abs(N - M) > p.abs(G - F) ? p.abs(N - M) > n.width() / 100 * c.touchSensitivity && (N > M ? l.m.right && e.moveSlideRight() : l.m.left && e.moveSlideLeft()) : c.autoScrolling && p.abs(G - F) > n.height() / 100 * c.touchSensitivity && (G > F ? L("down", g) : F > G && L("up", g)))
            }
        }
        ...
        function sa(a, b) {
            ...
            return b < c.normalScrollElementTouchThreshold &&
                g.is(c.normalScrollElements) ? !0 : b == c.normalScrollElementTouchThreshold ? !1 : sa(g, ++b)
        }
        ...
        function Ta(a) {
            a = a.originalEvent;
            c.fitToSection && x.stop();
            ca(a) && (a = ta(a), G = a.y, N = a.x)
        }

        function ua(a, b) {
            for (var c = 0, d = a.slice(p.max(a.length - b, 1)), e = 0; e < d.length; e++) c += d[e];
            return p.ceil(c / b)
        }
        ...
        function B(a) {
            ...
            if (c.autoScrolling && !O) {
                ...
                va = b;
                200 < g && (C = []);
                v && (b = ua(C, 10), g = ua(C, 70), b >= g && e && (0 > f ? L("down", a) : L("up", a)));
                return !1
            }
            c.fitToSection && x.stop()
        }
        ...
        function A(a, b, g) {
            requestAnimFrame(function () {
                ...
                if ("undefined" !== typeof f) {
                    var e = a.hasClass("fp-auto-height") ? f.top - r + a.height() : f.top,
                        f = {
                            element: a,
                            callback: b,
                            isMovementUp: g,
                    ...
                    if (!(f.activeSection.is(a) && !u || c.scrollBar && n.scrollTop() === f.dtop && !a.hasClass("fp-auto-height"))) {
                        if (f.activeSlide.length) var h = f.activeSlide.data("anchor"),
                            k = f.activeSlide.index();
                        c.autoScrolling && c.continuousVertical &&
                            "undefined" !== typeof f.isMovementUp && (!f.isMovementUp && "up" == f.yMovement || f.isMovementUp && "down" == f.yMovement) && (f.isMovementUp ? d(".fp-section.active").before(f.activeSection.nextAll(".fp-section")) : d(".fp-section.active").after(f.activeSection.prevAll(".fp-section").get().reverse()), I(d(".fp-section.active").position().top), xa(), f.wrapAroundElements = f.activeSection, f.dest = f.element.position(), f.dtop = f.dest.top, f.yMovement = Y(f.element));
                        if (d.isFunction(c.onLeave) && !f.localIsResizing) {
                            if (!1 === c.onLeave.call(f.activeSection,
                                    f.leavingSection, f.sectionIndex + 1, f.yMovement)) return;
                            Ua(f.activeSection)
                        }
                        a.addClass("active").siblings().removeClass("active");
                        K(a);
                        v = !1;
                        Z(k, h, f.anchorLink, f.sectionIndex);
                        Va(f);
                        z = f.anchorLink;
                        W(f.anchorLink, f.sectionIndex)
                    }
                }
            })
        }
        ...
        function Va(a) {
            if (c.css3 && c.autoScrolling && !c.scrollBar) ya("translate3d(0px, -" + a.dtop + "px, 0px)", !0), c.scrollingSpeed ? da = setTimeout(function () {
                ea(a)
            }, c.scrollingSpeed) : ea(a);
            else {
                var b = Wa(a);
        ...
        function ea(a) {
            a.wrapAroundElements && a.wrapAroundElements.length && (a.isMovementUp ? d(".fp-section:first").before(a.wrapAroundElements) : d(".fp-section:last").after(a.wrapAroundElements), I(d(".fp-section.active").position().top), xa());
        ...
        function qa(a) {
            a.find("video, audio").each(function () {
                var a = d(this).get(0);
                a.hasAttribute("autoplay") && "function" === typeof a.play &&
                    a.play()
            })
        }
        ...
        function za() {
            if (!X && !c.lockAnchors) {
                var a = k.location.hash.replace("#", "").split("/"),
                    ...
                    f = "undefined" === typeof z && "undefined" === typeof a && !w;
                b.length && (b && b !== z && !d || f || !w && fa != a) && V(b, a)
            }
        }

        function Xa(a) {
            v && (a.pageY < P ? e.moveSectionUp() : a.pageY > P && e.moveSectionDown());
            P = a.pageY
        }
        ...
        function H(a, b) {
            var g = b.position(),
                ...
                n = u;
            if (c.onSlideLeave) {
                var y = e.find(".fp-slide.active"),
                    q = y.index(),
                    r;
                r = q == f ? "none" : q > f ? "left" : "right";
                if (!n && "none" !== r && d.isFunction(c.onSlideLeave) && !1 === c.onSlideLeave.call(y, k, h + 1, q, r, f)) {
                    w = !1;
                    return
                }
            }
            ...
            e.hasClass("active") && Z(f, m, k, h);
            var t = function () {
                n || d.isFunction(c.afterSlideLoad) && c.afterSlideLoad.call(b, k, h + 1, m, f);
                w = !1
            };
            c.css3 ? (g = "translate3d(-" + p.round(g.left) + "px, 0px, 0px)", Aa(a.find(".fp-slidesContainer"), 0 < c.scrollingSpeed).css(Ba(g)), ha = setTimeout(function () {
                t()
        ...
        function Ca() {
            ...
            if (Q) {
                var a =
                    d(m.activeElement);
                a.is("textarea") || a.is("input") || a.is("select") || (a = n.height(), p.abs(a - ia) > 20 * p.max(ia, a) / 100 && (e.reBuild(!0), ia = a))
            } else clearTimeout(ja), ja = setTimeout(function () {
                e.reBuild(!0)
            }, 350)
        }
        ...
        function ya(a, b) {
            b ? Aa(h) : h.addClass("fp-notransition");
            h.css(Ba(a));
            setTimeout(function () {
        ...
        function Ea(a) {
            var b = d('.fp-section[data-anchor="' +
                a + '"]');
        ...
        function V(a, b) {
            ...
            a === z || c.hasClass("active") ? Fa(c, b) : A(c, function () {
                Fa(c, b)
            })
        }
        ...
        function Z(a, b, d, f) {
            f = "";
            c.anchors.length && !c.lockAnchors && (a ? ("undefined" !== typeof d && (f = d), "undefined" === typeof b && (b = a), fa = b, Ga(f + "/" + b)) : ("undefined" !== typeof a && (fa = b), Ga(d)));
            ma()
        }
        ...
        function La() {
            ...
            for (var d in c) a.style[d] !== E && (a.style[d] = "translate3d(1px,1px,1px)", b = k.getComputedStyle(a).getPropertyValue(c[d]));
        ...
        function Za() {
            if (Q || R) {
                var a = Ha();
                d(".fullpage-wrapper").off("touchstart " + a.down).on("touchstart " + a.down, Ta);
                d(".fullpage-wrapper").off("touchmove " + a.move).on("touchmove " + a.move, Sa)
            }
        }
        ...
        function ta(a) {
            ...
            R && ca(a) && c.scrollBar && (b.y = a.touches[0].pageY, b.x = a.touches[0].pageX);
            return b
        }
        ...
        function I(a) {
            c.scrollBar ? h.scrollTop(a) : c.css3 ? ya("translate3d(0px, -" + a + "px, 0px)", !1) : h.css("top", -a)
        }
        ...
        (function () {
            ...
            c.scrollBar && c.scrollOverflow && T("warn",
        ...
        e.setAutoScrolling = function (a, b) {
            ...
            c.autoScrolling && !c.scrollBar ? (x.css({
                overflow: "hidden",
                height: "100%"
            }), e.setRecordHistory(D.recordHistory, "internal"), h.css({
                "-ms-touch-action": "none",
                "touch-action": "none"
            }), g.length && I(g.position().top)) : (x.css({
                    overflow: "visible",
                    height: "initial"
                }),
                e.setRecordHistory(!1, "internal"), h.css({
                    "-ms-touch-action": "",
                    "touch-action": ""
                }), I(0), g.length && x.scrollTop(g.position().top))
        };
        ...
        e.setMouseWheelScrolling = function (a) {
            if (a) {
                ...
                var c = "onwheel" in m.createElement("div") ?
                    "wheel" : m.onmousewheel !== E ? "mousewheel" : "DOMMouseScroll";
        ...
        e.setAllowScrolling = function (a, b) {
            "undefined" !== typeof b ? (b = b.replace(/ /g, "").split(","), d.each(b, function (b, c) {
                Ia(a, c, "m")
            })) : a ? (e.setMouseWheelScrolling(!0), Za()) : (e.setMouseWheelScrolling(!1),
                $a())
        };
        ...
        e.reBuild = function (a) {
            if (!h.hasClass("fp-destroyed")) {
                ...
                d(".fp-section").each(function () {
                    ...
                    c.verticalCentered && d(this).find(".fp-tableCell").css("height", Da(d(this)) + "px");
                ...
                d.isFunction(c.afterResize) && a && c.afterResize.call(h);
                d.isFunction(c.afterReBuild) &&
                    !a && c.afterReBuild.call(h)
            }
        };
        ...
        t.keydown(function (a) {
            clearTimeout(Ka);
            var b = d(":focus");
            b.is("textarea") || b.is("input") || b.is("select") || !c.keyboardScrolling || !c.autoScrolling || (-1 < d.inArray(a.which, [40, 38, 32, 33, 34]) && a.preventDefault(), O = a.ctrlKey, Ka = setTimeout(function () {
                var b = a.shiftKey;
                switch (a.which) {
                    case 38:
                    case 33:
        ...
        c.normalScrollElements && (t.on("mouseenter", c.normalScrollElements, function () {
            e.setMouseWheelScrolling(!1)
        }), t.on("mouseleave", c.normalScrollElements, function () {
        ...
        e.destroy = function (a) {
            ...
            clearTimeout(aa);
            clearTimeout(ba);
            n.off("scroll", ra).off("hashchange", za).off("resize", Ca);
            t.off("click", "#fp-nav a").off("mouseenter", "#fp-nav li").off("mouseleave", "#fp-nav li").off("click", ".fp-slidesNav a").off("mouseover", c.normalScrollElements).off("mouseout", c.normalScrollElements);
